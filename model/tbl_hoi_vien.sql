...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th5 21, 2023 lúc 10:11 AM
...
INSERT INTO `tbl_hoi_vien` (`id_hv`, `name_hv`, `ngay_sinh`, `gioi_tinh`, `tuoi`, `sdt`, `cmnd`, `bien_xe`, `diem_tich_luy`, `chieu_cao`, `can_nang`, `phan_tram_mo`, `ngay_cap_nhat`) VALUES
(1, 'Nguyễn Văn Dick', '2023-08-10', 'Nam', 20, '45678610', '62763775', '3r90', 90, 1.78, 94, 10, '2023-05-03'),
...
(15, 'Nguyễn Thị Thảo', '2023-05-11', 'Nữ', 24, '973166263', '327362646', '2f34', 3, NULL, NULL, NULL, NULL);
...
--
ALTER TABLE `tbl_hoi_vien`
  MODIFY `id_hv` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
COMMIT;
