    ...
    <form action="../../../controller/controller_csvc/dung_cu_tap/dct_update.php?dctID=<?php echo $dctID?>" method="POST">
        <table class='dct__table--addform'>
            ...
            <tr>
                ...
                <td><input class='dct__table--add_input' type="text"  name="dct__table--add_so_luong" value="<?php echo $rows['so_luong']?>" placeholder="Quantity...."></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input class='dct__table--add_input' type="text"  name="dct__table--add_gia_nhap" value="<?php echo $rows['gia_nhap']?>" placeholder="Import Price...."></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input class='dct__table--add_input' type="text"  name="dct__table--add_chi_phi_bao_tri" value="<?php echo $rows['chi_phi_bao_tri']?>" placeholder="Maintenance Costs...."></td>
            </tr>
            <tr>
