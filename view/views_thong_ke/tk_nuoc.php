...
<body>
    ...
    <div class='tktp' name='tktp'style=" margin-top:30px; margin-left: 10px" >
            <button onclick="window.location.href='tk_nuoc.php'" style="font-size: 20px; border: 2px solid #3a72ff; border-radius: 50px; color: #2c4dfc; padding: 11px 14px 11px; cursor: pointer; background: #8cbadb;">Nước</button>
