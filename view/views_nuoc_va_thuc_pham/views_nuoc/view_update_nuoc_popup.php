...
<div class='nuoc__modal--popup'>
    ...
    <div >
    <form action="../../../controller/controller_nuoc_va_tp/controller_nuoc/nuoc_update.php?nuocID=<?php echo $nuocID?>" method="POST">
        <table class='nuoc__table--addform'>
            <tr>
                <td><label for="fname">Tên:</label></td>
                <td><input class='nuoc__table--add_input' type="text"  name="nuoc__table--add_ten" value="<?php echo $rows['name']?>" placeholder="Name...."></td>
            </tr>
            <tr>
                <td><label for="lname">Loại sản phẩm:</label></td>
                <td><input class='nuoc__table--add_input' type="text"  name="nuoc__table--add_loai_san_pham" value="<?php echo $rows['loai_tp']?>" placeholder="Type...."></td>
            </tr>
            <tr>
...
Import Price...."></td>
            ...
            <tr>
                ...
                <td><input class='nuoc__table--add_input' type="text"  name="nuoc__table--add_nha_cung_cap" value="<?php echo $rows['nha_cung_cap']?>" placeholder="Supplier...."></td>
            </tr>
            <tr>
                <td><label for="lname">Ngày nhập:</label></td>
                <td><input class='nuoc__table--add_input' type="date"  name="nuoc__table--add_ngay_nhap" value="<?php echo $rows['ngay_nhap']?>" placeholder="
Date Added...."></td>
            </tr>
            <tr>
                <td><label for="lname">Ngày hết hạn:</label></td>
                <td><input class='nuoc__table--add_input' type="date"  name="nuoc__table--add_ngay_het_han" value="<?php echo $rows['ngay_het_han']?>" placeholder="
Expiration date...."></td>
            </tr>
            
            <tr>
                <td colspan='2'>
                    <button class='nuoc__table--add-button nuoc__table--button_huy_update' type="button" onclick="window.location.href='nuoc.php'">Hủy</button>
                    <button class='nuoc__table--add-button nuoc__table--button_them_update' type="Submit"  onclick="" >Update</button>
                </td>
            </tr>
        </table>
    </form>
