    ...
    <form action="../../../controller/controller_nuoc_va_tp/controller_thuc_pham/tp_add.php?tpID=<?php echo $tpID?>" method="POST">
        <table class='tp__table--addform'>
            ...
            <td><label for="lname">Giá bán:</label></td>
                <td><input class='tp__table--add_input' type="text"  name="tp__table--add_gia_ban" value="<?php echo $rows['gia_ban']?>"></td>
            </tr>
            <tr>
                <td><label for="lname">Giá nhập:</label></td>
                <td><input class='tp__table--add_input' type="text"  name="tp__table--add_gia_nhap" value="<?php echo $rows['gia_nhap']?>"></td>
            </tr>
            <tr>
                <td><label for="lname">Số lượng nhập:</label></td>
                <td><input class='tp__table--add_input' type="text"  name="tp__table--add_so_luong_nhap" value="<?php echo $rows['so_luong_nhap']?>"></td>
            </tr>
            <tr>
                <td><label for="lname">Số lượng tồn:</label></td>
                <td><input class='tp__table--add_input' type="text"  name="tp__table--add_so_luong_ton" value="<?php echo $rows['so_luong_ton']?>"></td>
            </tr>
            <tr>
