    ...
    <form action="../controller/controller_nuoc_va_tp/nuoc_add.php" method="POST">
        <table class='nuoc__table--addform'>
            ...
            <tr>
                ...
                <td><input class='nuoc__table--add_input' type="text"  name="nuoc__table--add_loai_san_pham"></td>
            </tr>
            <tr>
            <td><label for="lname">Giá bán:</label></td>
                <td><input class='nuoc__table--add_input' type="text"  name="nuoc__table--add_gia_ban"></td>
            </tr>
            <tr>
                <td><label for="lname">Giá nhập:</label></td>
                <td><input class='nuoc__table--add_input' type="text"  name="nuoc__table--add_gia_nhap"></td>
            </tr>
            <tr>
                <td><label for="lname">Số lượng nhập:</label></td>
                <td><input class='nuoc__table--add_input' type="text"  name="nuoc__table--add_so_luong_nhap"></td>
            </tr>
            <tr>
                <td><label for="lname">Số lượng tồn:</label></td>
                <td><input class='nuoc__table--add_input' type="text"  name="nuoc__table--add_so_luong_ton"></td>
            </tr>
            <tr>
                <td><label for="lname">Nhà cung cấp:</label></td>
                <td><input class='nuoc__table--add_input' type="text"  name="nuoc__table--add_nha_cung_cap"></td>
            </tr>
            <tr>
                <td><label for="lname">Ngày nhập:</label></td>
                <td><input class='nuoc__table--add_input' type="text"  name="nuoc__table--add_ngay_nhap"></td>
            </tr>
            <tr>
                <td><label for="lname">Ngày hết hạn:</label></td>
                <td><input class='nuoc__table--add_input' type="text"  name="nuoc__table--add_ngay_het_han"></td>
            </tr>
            <tr>
                <td colspan='2'>
