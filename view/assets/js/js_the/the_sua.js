...
function suaCard() {
  ...
  const typesRoom = [...$$('input[name="types_room"]:checked')].map(input => input.value);
  ...
  xhthe.open('POST', '/da_web_nc/view/assets/js/js_the/the_sua.php', true);
