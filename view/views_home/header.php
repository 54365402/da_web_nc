        ...
        <div id="header">
            <div class="information">
                ...
                <div class="logout">
                    ...
                    <li><a href="https://www.facebook.com/profile.php?id=100019656524929" target="blank"><i class="fa-brands fa-facebook"></i></a></li>
            ...
            <div class="menu">
                <li class="menu-li" style="background-color: rgb(68, 84, 106);"><a class="menu-a" href="../views_home/home.php"><i class="fa-solid fa-house-user"></i> Trang chủ</a></li>
