<div class='tp__modal--popup'>
    ...
    <div >
    <form action="../controller/controller_nuoc_va_tp/tp_add.php" method="POST">
        <table class='tp__table--addform'>
            ...
            <tr>
                ...
                <td><input class='tp__table--add_input' type="text"  name="tp__table--add_loai_san_pham"></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input class='tp__table--add_input' type="text"  name="tp__table--add_nha_cung_cap"></td>
            </tr>
            <tr>
