...
<header>
        <div class="header--title">
            <div class="ktc_header__div--logo"><li class="ktc_header__li--logo"><img class="ktc_header__img--logo" src="./assets/img/logo.png" alt="LOGO"></li>
            </div>
        ...
        <div id="ktc_hoi_vien">
            <center><p id="ktc_hoi_vien__p" class = "ktc_hoi_vien__p">NGƯỜI THỰC - KẾT QUẢ THỰC</p></center>
        ...
        <div class="ktc_co_so_vat_chat__div">
            ...
            <div class = "ktc_co_so_vat_chat__div--doan_chu">
                <p class = "ktc_co_so_vat_chat__p">Là kết quả của 5 năm dày công đầu tư và nghiên cứu, 6 năm du học nước ngoài, không ngừng học hỏi kiến thức từ những HLV hàng đầu thế giới của Founder Nguyễn Hoàng Trí Dũng, để tạo ra một không gian tập luyện thoải mái, tiện nghi, đầy đủ mọi công năng và tính năng cần thiết</p>
            </div>
            ...
            <div class="ktc_goi_tap__div--goi_tap">
                ...
                <div class="ktc_goi_tap__div--goi_tap--khoi_bao_quanh">
                    <div class="ktc_goi_tap__div--goi_tap--menu ktc_goi_tap__div--goi_tap--menu__js1">
                        <div class="ktc_goi_tap__div--goi_tap__i1"><i class="fa-solid fa-plus ktc_goi_tap_i1--goi_tap--menu"></i></div>
                        <div class="ktc_goi_tap__div--goi_tap__span ktc_goi_tap__div--goi_tap__span1"><span class="ktc_goi_tap__span--goi_tap--menu">GÓI TẬP A.M</span></div>                            
                    </div>
                    <div class="ktc_goi_tap__div--goi_tap--content ktc_goi_tap__div--goi_tap--content__js1">
                        ...
                        <p class="ktc_goi_tap__p--goi_tap--content ">Gói tập phù hợp với các bạn cố định về mặt thời gian buổi sáng hoặc bạn muốn thử sức bền, độ kiên trì và kỉ luật cá nhân khi thức dậy sớm vào buổi sáng và luyện tập nghiêm túc. Bạn sẽ trải nghiệm đầy đủ cơ sở vật chất, chất lượng dịch vụ, không khí tập luyện máu lửa ở Swequity, cũng như nhìn thấy kết quả của sau quá trình rèn luyện kỉ luật.</p>
                        </div>
                    </div>
                    <div class="ktc_goi_tap__div--goi_tap--menu ktc_goi_tap__div--goi_tap--menu__js2">
                        <div class="ktc_goi_tap__div--goi_tap__i2"><i class="fa-solid fa-plus ktc_goi_tap_i2--goi_tap--menu"></i></div>
                        <div class="ktc_goi_tap__div--goi_tap__span ktc_goi_tap__div--goi_tap__span1"><span class="ktc_goi_tap__span--goi_tap--menu">GÓI TẬP FULL-TIME</span></div>                   
                    ...
                    <div class="ktc_goi_tap__div--goi_tap--menu ktc_goi_tap__div--goi_tap--menu__js3">
                        <div class="ktc_goi_tap__div--goi_tap__i3"><i class="fa-solid fa-plus ktc_goi_tap_i3--goi_tap--menu"></i></div>
                        <div class="ktc_goi_tap__div--goi_tap__span ktc_goi_tap__div--goi_tap__span1"><span class="ktc_goi_tap__span--goi_tap--menu">GÓI TẬP V.I.P</span></div>                                                             
                    </div>
                    <div class="ktc_goi_tap__div--goi_tap--content ktc_goi_tap__div--goi_tap--content__js3">
                        ...
                        <p class="ktc_goi_tap__p--goi_tap--content ">Với gói tập V.I.P bạn có thể tập luyện tại mọi cơ sở của Swequity với khung thời gian linh hoạt tùy theo nhu cầu bản thân. Bạn không cần tập quá sức, bạn chỉ cần tập theo phương pháp chuẩn chỉnh để có được kết quả tốt nhất. Với phương pháp tập gym đúng chuẩn tại Swequity bạn sẽ nhận được kết quả xứng đáng với thời gian, công sức và tiền bạc mình bỏ ra.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div id="footer" class="ktc__footer">
            ...
            <div class="ktc__footer__div ktc__footer__div3">
                ...
                <div class="ktc_footer__div--ke_ngang">  </div>
                <strong class="ktc__footer__strong"><i class="fa-brands fa-facebook"></i><a class="ktc_footer_mang_xa_hoi__a" href="https://www.facebook.com/profile.php?id=100090803259694"> https://www.facebook.com/profile.php?id=100090803259694</a> </strong>
                <strong class="ktc__footer__strong"><i class="fa-brands fa-instagram"></i><a class="ktc_footer_mang_xa_hoi__a" href="https://www.facebook.com/profile.php?id=100090803259694"> https://www.facebook.com/profile.php?id=100090803259694</a> </strong>
                <strong class="ktc__footer__strong"><i class="fa-brands fa-youtube"></i><a class="ktc_footer_mang_xa_hoi__a" href="https://www.facebook.com/profile.php?id=100090803259694"> https://www.facebook.com/profile.php?id=100090803259694</a> </strong>
