...
if (
    ...
    $sql = "INSERT INTO tbl_hoi_vien (name_hv, ngay_sinh, gioi_tinh, tuoi, sdt, email, cmnd, bien_xe, diem_tich_luy) VALUES ('" . $hoivien->get_name_hv() . "','" . $hoivien->get_ngay_sinh() . "','" . $hoivien->get_gioi_tinh() . "','" . $hoivien->get_tuoi() . "','" . $hoivien->get_sdt() . "','" .$hoivien->get_email(). "','" . $hoivien->get_cmnd() . "','" . $hoivien->get_bien_xe() . "','" . $hoivien->get_diem_tich_luy() . "')";
