<?php
    ...
    $sql = "INSERT INTO card(id_hv,card_id,id_nv,packages,quantity,types_room,time_start,time_end,total_money) VALUES('".$the->get_id_hv()."','".$the->get_card_id()."','".$the->get_id_nv()."','".$the->get_goi_tap()."','".$the->get_so_luong()."','".$the->get_lop()."','".$the->get_ngay_bat_dau()."','".$the->get_ngay_ket_thuc()."','".$the->get_thanh_tien()."')";
