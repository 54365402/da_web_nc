        ...
        while($row = mysqli_fetch_array($query))
       {
        ...
        <div class='td__div--chua_button-all'>
            ...
            <div class='td__div--chua_button'>
                <div class='td__div--chua_button--sua-gui'><button class='td__div--button js-sua' type="button"
                        onclick="">Sửa</button></div>
                <form class="td__form--sendDate" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>"
                    method="POST">
            ...
            <div class='td__div--chua_button-gift'><button class='td__div--button js-them' type="button"
                    onclick="">Thêm</button></div>
